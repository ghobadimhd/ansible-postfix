...
def get_key(value):
    ...
    if not isinstance(value, dict):
       raise AnsibleError("input should be a dict, but was given a input of %s" % (type(value)))
...
def dictlist2items(value):
    ...
    if not isinstance(value, list):
       raise AnsibleError("input should be a list, but was given a input of %s" % type(value) )
